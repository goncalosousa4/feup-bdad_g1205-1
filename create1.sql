...
FOREIGN KEY(id_aluguer) REFERENCES ALUGUER(id) ON DELETE CASCADE,
FOREIGN KEY(id_seguro) REFERENCES SEGURO(id) ON DELETE CASCADE
);
...
FOREIGN KEY(aid) REFERENCES PLANO_ALUGUER(id) ON DELETE CASCADE,
FOREIGN KEY(nome) REFERENCES MODELO(nome) ON DELETE CASCADE
);
...
FOREIGN KEY(morada) REFERENCES LOCAL_LEVANTAMENTO(morada) ON UPDATE CASCADE,
FOREIGN KEY(plano_id) REFERENCES PLANO_ALUGUER(id) ON UPDATE CASCADE
);
...
FOREIGN KEY(aluguer_id) REFERENCES ALUGUER(id) ON DELETE CASCADE,
...
FOREIGN KEY(aluguer_id) REFERENCES ALUGUER(id) ON DELETE CASCADE,
FOREIGN KEY(funcionario_id) REFERENCES FUNCIONARIO(id) ON UPDATE CASCADE
);
...
morada TEXT PRIMARY KEY NOT NULL
);
